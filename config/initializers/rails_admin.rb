...
# RailsAdmin config file. Generated on November 04, 2011 01:57
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Technews', 'Admin']
  ...
  # config.excluded_models << [Category, FeedEntry, FeedSite, Role, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Category, FeedEntry, FeedSite, Role, User]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :feed_sites, :has_many_association
  ...
  #   field :default_home, :boolean

  #   field :owner_id, :integer        # Hidden
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :feed_site, :belongs_to_association
  ...
  #   field :feed_site_id, :integer        # Hidden
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :feed_entries, :has_many_association
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  #   field :own_categories, :has_many_association
  ...
  #   field :feeds_per_page, :integer

  #   field :font_size, :float

  #   field :home_page_category_id, :integer
